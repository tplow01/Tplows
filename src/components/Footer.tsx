...
function InstagramIcon() {
  return (
    <svg width="48" height="48" viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
      <rect x="6.5" y="6.5" width="35" height="35" rx="10" stroke="var(--text-inverse)" strokeWidth="3"/>
      <circle cx="24" cy="24" r="8.5" stroke="var(--text-inverse)" strokeWidth="3"/>
      <circle cx="35" cy="13" r="2.5" fill="var(--text-inverse)"/>
    </svg>
  )
}
...
function GithubIcon() {
  return (
    <svg width="48" height="48" viewBox="0 0 48 48" fill="var(--text-inverse)" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
...
function LinkedInIcon() {
  return (
    <svg width="48" height="48" viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
      <rect x="4.5" y="4.5" width="39" height="39" rx="6" stroke="var(--text-inverse)" strokeWidth="3"/>
      <rect x="13" y="20" width="5" height="15" fill="var(--text-inverse)"/>
      <circle cx="15.5" cy="14.5" r="2.5" fill="var(--text-inverse)"/>
      <path d="M22 20h5v2.4C27.7 20.9 29.6 20 31.8 20c4.2 0 5.7 2.8 5.7 6.9V35h-5v-7.4c0-2-.4-3.6-2.5-3.6s-3 1.7-3 3.4V35H22V20z" fill="var(--text-inverse)"/>
    </svg>
  )
}
...
export default function Footer({ fromColor = 'var(--surface-card)' }: { fromColor?: string }) {
  ...
  return (
    <footer style={{
      background: `linear-gradient(to top, var(--c-orange) 0%, ${fromColor} 100%)`,
      display: 'flex',
      alignItems: 'center',
      ...
      <div style={{
        ...
        {/* Logo icon mark — TransitionLink on other pages, scroll-to-top on home */}
        {pathname === '/' ? (
          <a href="/" aria-label="Back to top" style={{ display: 'block', flexShrink: 0 }} onClick={handleLogoClick}>
            <LogoSVG />
          </a>
        ) : (
          <TransitionLink href="/" aria-label="Go to home" style={{ display: 'block', flexShrink: 0 }}>
            <LogoSVG />
          </TransitionLink>
        )}
