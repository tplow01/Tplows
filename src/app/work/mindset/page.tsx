...
// Mindset page now uses the global home-derived semantic palette tokens.
    ...
    <>
      ...
      <style>{`
        ...
        /* ── Full-bleed section dividers ─────────────────────────────────
           ...
           Strokes are Mindset teal (var(--c-orange)).
        ─────────────────────────────────────────────────────────────── */
      ...
      <div className="ms">
        ...
        <div className="ms-case-hdr">
          ...
          <CaseLabel label="Mindset" accent="var(--c-orange)" className="ms-case-hdr-label" />
        </div>
        ...
        <div className="ms-section-hdr">
          <CaseLabel label="The Problem" accent="var(--c-orange)" className="ms-section-hdr-label" />
